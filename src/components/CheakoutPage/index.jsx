  ...
  const getAllAddress = () => {
    axios
      ...
      .then((res) => {
        if (res.data) {
          setSslStatus(
            !!(res.data.sslcommerz && res.data.sslcommerz.status === "1")
          );
          setPaypalStatus(
            !!(
          ...
          setInstaMojoStatus(
            !!(res.data.instamojo && res.data.instamojo.status === "1")
          );
          setMollieStatus(
            !!(
              res.data.paystackAndMollie &&
          ...
          setBankInfo(res.data.bankPaymentInfo && res.data.bankPaymentInfo);
          setShipppingRules(res.data.shippings);
          ...
          if (res.data.addresses && res.data.addresses.length > 0) {
            setShipping(res.data.addresses[0].id);
            setBilling(res.data.addresses[0].id);
          }
        }
